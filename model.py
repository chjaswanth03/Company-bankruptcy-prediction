...
model = joblib.load(r'C:\Users\JASWANTH CH\OneDrive\Desktop\@SEM 5\Mini project\project - wine quality\Project code (Web Development)\wine_quality_prediction\Machine Learning code\wine_quality_model.pkl')
